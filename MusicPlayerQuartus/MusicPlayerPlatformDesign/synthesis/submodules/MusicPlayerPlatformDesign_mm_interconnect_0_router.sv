...
module MusicPlayerPlatformDesign_mm_interconnect_0_router_default_decode
  #(
...
module MusicPlayerPlatformDesign_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD10 = log2ceil(64'h83088 - 64'h83080); 
    localparam PAD11 = log2ceil(64'h83090 - 64'h83088); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h83090;
