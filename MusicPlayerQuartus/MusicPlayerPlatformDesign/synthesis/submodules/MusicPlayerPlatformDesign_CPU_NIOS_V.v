// MusicPlayerPlatformDesign_CPU_NIOS_V.v
...
`timescale 1 ps / 1 ps
module MusicPlayerPlatformDesign_CPU_NIOS_V (
	...
	dm_top #(
		...
		.dbg_reset_out      ()                          // dbg_reset_out.reset
	);

	MusicPlayerPlatformDesign_CPU_NIOS_V_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	MusicPlayerPlatformDesign_CPU_NIOS_V_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	MusicPlayerPlatformDesign_CPU_NIOS_V_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
